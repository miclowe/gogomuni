# RailsAdmin config file. Generated on June 09, 2013 14:45
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Gogomuni', 'Admin']
  ...
  # config.excluded_models = ['Route', 'Stop', 'Transit', 'User']

  # Include specific models (exclude the others):
  # config.included_models = ['Route', 'Stop', 'Transit', 'User']
  ...
  #   # You can copy this to a 'rails_admin do ... end' block inside your stop.rb model definition
  ...
  # config.model 'Transit' do

  #   # You can copy this to a 'rails_admin do ... end' block inside your transit.rb model definition
